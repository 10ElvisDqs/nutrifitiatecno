<div>
    <div class="hidden sm:flex">
        <div class="flex justify-center 2xl:flex-nowrap gap-x-2">
            {{-- parte frontal --}}
            <svg viewBox="0 0 660.46 1206.46" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-full h-[38rem]">
                <defs>
                ...
                <g id="body" class="body-map__model">
                    ...
                    <line x1="330.29" y1="504.57" x2="330.29" y2="571.92" fill="none"
                        stroke="#484a68" stroke-linecap="round" stroke-linejoin="round" stroke-width="3.46"></line>
                    ...
                    <path
                        ...
                        fill="none" stroke="#484a68" stroke-linecap="round" stroke-linejoin="round"
                        stroke-width="3.46"></path>
                    <path d="M229.53,518.28c19.21,4.08,52.48,20.12,65.45,64.94,12.97,44.82,19.66,61.4,35.08,61.4"
                        fill="none" stroke="#484a68" stroke-linecap="round" stroke-linejoin="round"
                        stroke-width="3.46"></path>
                    <path
                    ...
                    <line x1="330.4" y1="504.57" x2="330.4" y2="571.92" fill="none"
                        stroke="#484a68" stroke-linecap="round" stroke-linejoin="round" stroke-width="3.46"></line>
                    <path d="M631.46,521.95v.02c-1.13,7.67-5.05,13.92-10.29,16.59-4.74,2.41-10.96,2.08-17.03-.58"
                        fill="none" stroke="#484a68" stroke-linecap="round" stroke-linejoin="round"
                        stroke-width="3.46"></path>
                    <path
                    ...
                    <path
                        ...
                        fill="none" stroke="#484a68" stroke-linecap="round" stroke-linejoin="round"
                        stroke-width="3.46"></path>
                    <path d="M370.9,162.48v37.06c0,11.68,7.04,15.63,17.89,19.34.54.18,1.1.36,1.67.52" fill="none"
                        stroke="#484a68" stroke-linecap="round" stroke-linejoin="round" stroke-width="3.46"></path>
                    <path
                    ...
                    <path
                        ...
                        fill="none" stroke="#484a68" stroke-linecap="round" stroke-linejoin="round"
                        stroke-width="3.46"></path>
                    <path d="M430.93,518.28c-19.21,4.08-52.48,20.12-65.45,64.94-12.97,44.82-19.66,61.4-35.08,61.4"
                        fill="none" stroke="#484a68" stroke-linecap="round" stroke-linejoin="round"
                        stroke-width="3.46"></path>
                    <path
                    ...
                    <path
                        ...
                        fill="none" stroke="#484a68" stroke-linecap="round" stroke-linejoin="round"
                        stroke-width="3.46"></path>
                    <path d="M644.72,636.36s-8.45,1.08-7.1-7.4c1.35-8.48-.36-10.41-.19-18.76s-6.15-8.33-4.52-24.4"
                        fill="none" stroke="#484a68" stroke-linecap="round" stroke-linejoin="round"
                        stroke-width="3.46"></path>
                    <path
                ...
                <g id="shoulders" class="hidden">
                    ...
                    <ellipse cx="441.13" cy="261.13" rx="12.04" ry="12.3" fill="currentColor"
                        stroke-linecap="round" stroke-linejoin="round" stroke-width="3.46"></ellipse>
                    <ellipse cx="219.33" cy="261.13" rx="12.04" ry="12.3" fill="currentColor"
                        stroke-linecap="round" stroke-linejoin="round" stroke-width="3.46"></ellipse>
                </g>
                <g id="elbow" class="hidden">
                    ...
                    <ellipse id="hover-7" data-name="hover" cx="541.86" cy="412.77" rx="24.71"
                        ry="25.24" fill="url(#jointradial)" opacity="1" stroke-width="0"></ellipse>
                    <ellipse cx="541.86" cy="412.77" rx="12.04" ry="12.3" fill="currentColor"
                        stroke-linecap="round" stroke-linejoin="round" stroke-width="3.46"></ellipse>
                    <ellipse cx="118.6" cy="412.77" rx="12.04" ry="12.3" fill="currentColor"
                        stroke-linecap="round" stroke-linejoin="round" stroke-width="3.46"></ellipse>
                </g>
                <g id="wrist" class="hidden">
                    ...
                    <ellipse id="hover-8" data-name="hover" cx="618.05" cy="531.02" rx="24.71"
                        ry="25.24" fill="url(#jointradial)" opacity="1" stroke-width="0"></ellipse>
                    <ellipse cx="618.05" cy="531.02" rx="12.04" ry="12.3" fill="currentColor"
                        stroke-linecap="round" stroke-linejoin="round" stroke-width="3.46"></ellipse>
                    <ellipse cx="42.41" cy="531.02" rx="12.04" ry="12.3" fill="currentColor"
                        stroke-linecap="round" stroke-linejoin="round" stroke-width="3.46"></ellipse>
                </g>
                <g id="hips" class="hidden">
                    ...
                    <ellipse id="hover-5" data-name="hover" cx="247.71" cy="523.37" rx="24.71"
                        ry="25.24" fill="url(#jointradial)" opacity="1" stroke-width="0"></ellipse>
                    <ellipse cx="412.75" cy="523.37" rx="12.04" ry="12.3" fill="currentColor"
                        stroke-linecap="round" stroke-linejoin="round" stroke-width="3.46"></ellipse>
                    <ellipse cx="247.71" cy="523.37" rx="12.04" ry="12.3" fill="currentColor"
                        stroke-linecap="round" stroke-linejoin="round" stroke-width="3.46"></ellipse>
                </g>
                <g id="knees" class="hidden">
                    ...
                    <ellipse id="hover-9" data-name="hover" cx="241.09" cy="874.7" rx="24.71"
                        ry="25.24" fill="url(#jointradial)" opacity="1" stroke-width="0"></ellipse>
                    <ellipse cx="419.37" cy="874.7" rx="12.04" ry="12.3" fill="currentColor"
                        stroke-linecap="round" stroke-linejoin="round" stroke-width="3.46"></ellipse>
                    <ellipse cx="241.09" cy="874.7" rx="12.04" ry="12.3" fill="currentColor"
                        stroke-linecap="round" stroke-linejoin="round" stroke-width="3.46"></ellipse>
                </g>
                <g id="ankles" class="hidden">
                    ...
                    <ellipse id="hover-12" data-name="hover" cx="439.32" cy="1105.65" rx="24.71"
                        ry="25.24" fill="url(#jointradial)" opacity="1" stroke-width="0"></ellipse>
                    <ellipse cx="439.32" cy="1105.65" rx="12.04" ry="12.3" fill="currentColor"
                        stroke-linecap="round" stroke-linejoin="round" stroke-width="3.46"></ellipse>
                    <ellipse cx="221.14" cy="1105.65" rx="12.04" ry="12.3" fill="currentColor"
                        stroke-linecap="round" stroke-linejoin="round" stroke-width="3.46"></ellipse>
                </g>
            </svg>
            {{-- parte trasera --}}
            <svg viewBox="0 0 660.46 1206.46" fill="none" xmlns="http://www.w3.org/2000/svg"
                ...
                >
                    ...
                    <line x1="330.26" y1="553.71" x2="330.26" y2="614.06" fill="none"
                        stroke="#484a68" stroke-linecap="round" stroke-linejoin="round" stroke-width="3.52"></line>
                    <path
                ...
                <g id="ankles" class="hidden">
                    ...
                    <ellipse id="hover-8" data-name="hover" cx="214.71" cy="1119.64" rx="25.53"
                        ry="25.24" fill="url(#jointradial)" opacity="1" stroke-width="0"></ellipse>
                    <ellipse cx="214.71" cy="1119.64" rx="12.44" ry="12.3" fill="currentColor"
                        stroke-linecap="round" stroke-linejoin="round" stroke-width="3.52"></ellipse>
                    <ellipse cx="445.81" cy="1119.64" rx="12.44" ry="12.3" fill="currentColor"
                        stroke-linecap="round" stroke-linejoin="round" stroke-width="3.52"></ellipse>
                </g>
                <g id="knees" class="hidden">
                    ...
                    <ellipse id="hover-10" data-name="hover" cx="423.36" cy="879.63" rx="25.53"
                        ry="25.24" fill="url(#jointradial)" opacity="1" stroke-width="0"></ellipse>
                    <ellipse cx="423.36" cy="879.63" rx="12.44" ry="12.3" fill="currentColor"
                        stroke-linecap="round" stroke-linejoin="round" stroke-width="3.52"></ellipse>
                    <ellipse cx="237.16" cy="879.63" rx="12.44" ry="12.3" fill="currentColor"
                        stroke-linecap="round" stroke-linejoin="round" stroke-width="3.52"></ellipse>
                </g>
                <g id="wrist" class="hidden">
                    ...
                    <ellipse id="hover-11" data-name="hover" cx="629.98" cy="548.63" rx="25.53"
                        ry="25.24" fill="url(#jointradial)" opacity="1" stroke-width="0"></ellipse>
                    <ellipse cx="629.98" cy="548.63" rx="12.44" ry="12.3" fill="currentColor"
                        stroke-linecap="round" stroke-linejoin="round" stroke-width="3.52"></ellipse>
                    <ellipse cx="30.54" cy="548.63" rx="12.44" ry="12.3" fill="currentColor"
                        stroke-linecap="round" stroke-linejoin="round" stroke-width="3.52"></ellipse>
                </g>
                <g id="elbow" class="hidden">
                    ...
                    <ellipse id="hover-12" data-name="hover" cx="540.68" cy="396.23" rx="25.53"
                        ry="25.24" fill="url(#jointradial)" opacity="1" stroke-width="0"></ellipse>
                    <ellipse cx="540.68" cy="396.23" rx="12.44" ry="12.3" fill="currentColor"
                        stroke-linecap="round" stroke-linejoin="round" stroke-width="3.52"></ellipse>
                    <ellipse cx="119.84" cy="396.23" rx="12.44" ry="12.3" fill="currentColor"
                        stroke-linecap="round" stroke-linejoin="round" stroke-width="3.52"></ellipse>
                </g>
                <g id="upper-spine" class="hidden">
                    <ellipse id="hover" cx="330.26" cy="209.3" rx="25.53" ry="25.24"
                        fill="url(#jointradial)" opacity="1" stroke-width="0"></ellipse>
                    <ellipse cx="330.26" cy="209.3" rx="12.44" ry="12.3" fill="currentColor"
                        stroke-linecap="round" stroke-linejoin="round" stroke-width="3.52"></ellipse>
                </g>
                <g id="scapula" class="hidden">
                    ...
                    <ellipse id="hover-3" data-name="hover" cx="420.4" cy="271.32" rx="25.53"
                        ry="25.24" fill="url(#jointradial)" opacity="1" stroke-width="0"></ellipse>
                    <ellipse cx="420.4" cy="271.32" rx="12.44" ry="12.3" fill="currentColor"
                        stroke-linecap="round" stroke-linejoin="round" stroke-width="3.52"></ellipse>
                    <ellipse cx="240.12" cy="271.32" rx="12.44" ry="12.3" fill="currentColor"
                        stroke-linecap="round" stroke-linejoin="round" stroke-width="3.52"></ellipse>
                </g>
                <g id="lower-spine" class="hidden">
                    <ellipse id="hover-4" data-name="hover" cx="330.26" cy="491.77" rx="25.53"
                        ry="25.24" fill="url(#jointradial)" opacity="1" stroke-width="0"></ellipse>
                    <ellipse cx="330.26" cy="491.77" rx="12.44" ry="12.3" fill="currentColor"
                        stroke-linecap="round" stroke-linejoin="round" stroke-width="3.52"></ellipse>
                </g>
            </svg>
        </div>
