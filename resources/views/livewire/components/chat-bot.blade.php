<div class="relative" x-data="{
    ...
    <div class="flex space-x-4">
        <div class="bg-blue-500 h-24 w-1/4">Columna 1</div> <!-- 25% del ancho -->
        <div class="bg-green-500 h-24 w-1/2">Columna 2</div> <!-- 50% del ancho -->
        <div class="bg-red-500 h-24 w-1/4">Columna 3</div> <!-- 25% del ancho -->
    </div>
